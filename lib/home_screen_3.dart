                ...
                SlidingUpPanel(
                  ...
                  panel: SingleChildScrollView(
                    child: Container(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Image(
                                          image:
                                              AssetImage("images/Group 48.png"),
                                          width: 24.55,
                                          height: 40,
                                        ),
                                      ),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Padding(
                                        padding:
                                            const EdgeInsets.only(right: 41.0),
                                        child: Column(
                                          crossAxisAlignment:
                                              CrossAxisAlignment.start,
                                          children: [
                      ...
                      //                   //   //                   ),
                      //                   //   //                   SizedBox(width: 10,),
                      //                   //   //                   Image(image: AssetImage("images/fav_icon.png"),width: 24,height: 24,fit: BoxFit.fill,)
                      //                   //   //                 ],
                      //                   //   //               ),
                      //                   //   //               Padding(
                      //                   //   //                 padding: const EdgeInsets.only(left:8.0),
                  ...
                  body: Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage("images/Frame_2.png"),
                              fit: BoxFit.fill)),
                      child: Column(
                        children: [
                          Column(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Image(
                                        image:
                                            AssetImage("images/Group 330.png"),
                                        width: 64.5,
                                        height: 17.12,
                                      ),
                                      SizedBox(
                ...
                items: [
                  BottomNavigationBarItem(
                    ...
                    icon: selectedTab == 0
                      ...
                      context,
                      MaterialPageRoute(builder: (context) =>Allow_Page  ()),
                    );},
                          child: Container(
                  ...
                  BottomNavigationBarItem(
                    ...
                    icon: selectedTab == 1
                      ...
                      MaterialPageRoute(builder: (context) =>Bottom_Navigation  ()),
                        ...
                        : SvgPicture.asset("images/Vector_2.svg",color: Color(0xFF9DB2CE),),
                  ),
                  BottomNavigationBarItem(
                    label: "",
                    icon: selectedTab == 2
                        ? GestureDetector(onTap: (){Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>Job_Application()),
                    );},
                          child: Container(
                                                padding: EdgeInsets.all(10),
                                                width: 100,
