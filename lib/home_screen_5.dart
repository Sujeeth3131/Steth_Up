...
class Home_Screen_5 extends StatefulWidget {
  const Home_Screen_5({super.key});

  @override
  State<Home_Screen_5> createState() => _Home_Screen_5State();
}

class _Home_Screen_5State extends State<Home_Screen_5> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
        SlidingUpPanel(onPanelOpened:() {
                             print("Panel is fully opened!");
